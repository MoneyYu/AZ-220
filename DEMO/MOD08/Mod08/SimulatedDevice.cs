    ...
    class SimulatedDevice
    {
        ...
        private static Task<MethodResponse> SetTelemetryInterval(MethodRequest methodRequest, object userContext)
        {
            ...
            if (Int32.TryParse(data, out _telemetryInterval))
            {
                ...
                Console.WriteLine($"{DateTime.Now:MM-dd HH:mm:ss} Telemetry interval set to {0} seconds", data);
                Console.ResetColor();

                // Acknowlege the direct method call with a 200 success message
                string result = "{\"result\":\"Executed direct method: " + methodRequest.Name + " at " +
        ...
        private static void Main(string[] args)
        {
            ...
            _deviceClient = DeviceClient.CreateFromConnectionString(s_connectionString, TransportType.Mqtt);
